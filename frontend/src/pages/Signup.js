  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#44445a', fontSize: '14px', marginBottom: '32px' }}>Create your account to get started!</p>
        ...
        <div style={{ marginBottom: '16px' }}>
          <label style={{ color: '#8888aa', fontSize: '12px', display: 'block', marginBottom: '6px' }}>NAME</label>
          <input
            type="text"
            value={name}
